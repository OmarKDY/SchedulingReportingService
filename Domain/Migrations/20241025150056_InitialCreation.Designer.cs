...
namespace SchedulingReportingService.Domain.Migrations
{
    ...
    [Migration("20241025150056_InitialCreation")]
            ...
            modelBuilder.Entity("SchedulingReportingService.Domain.Entities.Orders", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrderId = 1,
                            OrderDate = new DateTime(2024, 10, 25, 18, 0, 55, 864, DateTimeKind.Local).AddTicks(173),
                            Status = "Placed",
                            UserId = 0
                        });
                });
            ...
            modelBuilder.Entity("SchedulingReportingService.Domain.Entities.Sales", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SaleId = 1,
                            Amount = 1000m,
                            Date = new DateTime(2024, 10, 25, 18, 0, 55, 864, DateTimeKind.Local).AddTicks(102),
                            OrderId = 0,
                            UserId = 0
                        });
                });
            ...
            modelBuilder.Entity("SchedulingReportingService.Domain.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Name = "Omar",
                            RegisteredDate = new DateTime(2024, 10, 25, 18, 0, 55, 863, DateTimeKind.Local).AddTicks(9949)
                        });
                });
